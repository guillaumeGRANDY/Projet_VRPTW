...
public class TabuSearch2 {
    ...
    public boolean isAllowed(LocalSearchType searchType,List<Integer> parameters)
    {
        ...
        {
            if(tabu.getKey()==searchType && tabu.getValue().equals(parameters))
            {
                return false;
            }
        }
            ...
            for (int indexLivraison1 = 0; indexLivraison1 < initialTour.getRoutes().get(indexRoute).getLivraisons().size()-1; indexLivraison1++) {
                for (int indexLivraison2 = indexLivraison1 + 1; indexLivraison2 < initialTour.getRoutes().get(indexRoute).getLivraisons().size(); indexLivraison2++) {
                    ...
                    if (siblingTour.distance() < bestDistance && this.isAllowed(LocalSearchType.ECHANGE_INTRA, Arrays.asList(indexRoute,indexLivraison1,indexLivraison2)))
                    {
                        ...
                        operateurBestTour=new Pair<>(LocalSearchType.ECHANGE_INTRA, Arrays.asList(indexRoute,indexLivraison2,indexLivraison1));
                    ...
                    for (int indexLivraisonRoute2 = 0; indexLivraisonRoute2 < initialTour.getRoutes().get(indexRoute2).getLivraisons().size(); indexLivraisonRoute2++) {
                        ...
                        if(siblingTour.tryExchangeInter(indexRoute1, indexLivraisonRoute1, indexRoute2, indexLivraisonRoute2))
                        {
                            if (siblingTour.distance() < bestDistance && this.isAllowed(LocalSearchType.ECHANGE_INTER, Arrays.asList(indexRoute1,indexRoute2,indexLivraisonRoute1,indexLivraisonRoute2)))
                            {
                                bestTour = siblingTour;
                                bestDistance=siblingTour.distance();
                                operateurBestTour=new Pair<>(LocalSearchType.ECHANGE_INTER, Arrays.asList(indexRoute2,indexRoute1,indexLivraisonRoute2,indexLivraisonRoute1));
            ...
            for (int indexLivraison1 = 0; indexLivraison1 < initialTour.getRoutes().get(indexRoute).getLivraisons().size(); indexLivraison1++) {
                for (int indexLivraison2 = indexLivraison1 + 1; indexLivraison2 < initialTour.getRoutes().get(indexRoute).getLivraisons().size(); indexLivraison2++) {
                    ...
                    if (siblingTour.distance() < bestDistance && this.isAllowed(LocalSearchType.RELOCATE_INTRA,Arrays.asList(indexRoute, indexLivraison1, indexLivraison2)))
                    {
                        bestTour = siblingTour;
                        bestDistance=siblingTour.distance();
                        operateurBestTour = new Pair<>(LocalSearchType.RELOCATE_INTRA, Arrays.asList(indexRoute, indexLivraison2, indexLivraison1));
                    ...
                    for (int indexLivraisonRoute2 = 0; indexLivraisonRoute2 < initialTour.getRoutes().get(indexRoute2).getLivraisons().size(); indexLivraisonRoute2++) {
                        ...
                        if(siblingTour.tryRelocateInter(indexRoute1, indexLivraisonRoute1, indexRoute2, indexLivraisonRoute2))
                        {
                            if (siblingTour.distance() < bestDistance && this.isAllowed(LocalSearchType.RELOCATE_INTER, Arrays.asList(indexRoute1, indexRoute2, indexLivraisonRoute1, indexLivraisonRoute2)))
                            {
                                bestTour = siblingTour;
                                bestDistance=siblingTour.distance();
                                operateurBestTour = new Pair<>(LocalSearchType.RELOCATE_INTER, Arrays.asList(indexRoute2, indexRoute1, indexLivraisonRoute2, indexLivraisonRoute1));
...
//                    for (int indexLivraisonNew = 0; indexLivraisonNew < initialTour.getRoutes().get(indexRoute).getLivraisons().size(); indexLivraisonNew++) {
//
//                        Tour siblingTour = new Tour(initialTour);
//
//                        siblingTour.getRoutes().get(indexRoute).tryIntraGroupeExchange(indexLivraisonOld1, indexLivraisonOld2, indexLivraisonNew);
//
//                        if (siblingTour.distance() < bestDistance && this.isAllowed(siblingTour))
//                        {
//                            bestTour = siblingTour;
//                            bestDistance=siblingTour.distance();
...
//                    for (int indexLivraison2Route1 = indexLivraison1Route1; indexLivraison2Route1 < initialTour.getRoutes().get(indexRoute1).getLivraisons().size(); indexLivraison2Route1++) {
...
//                            for (int indexLivraison2Route2 = indexLivraison1Route2; indexLivraison2Route2 < initialTour.getRoutes().get(indexRoute2).getLivraisons().size(); indexLivraison2Route2++) {
//                                if(indexLivraison1Route1!=0 || indexLivraison2Route1 != initialTour.getRoutes().get(indexRoute1).getLivraisons().size()-1 || indexLivraison1Route2!=0 || indexLivraison2Route2!= initialTour.getRoutes().get(indexRoute1).getLivraisons().size()-1) {
//                                    Tour siblingTour = new Tour(initialTour);
//
...
//                                            bestTour = siblingTour;
//                                            bestDistance = siblingTour.distance();
//                                            operateurBestTour = new Pair<>(LocalSearchType.ECHANGE_GROUPE_INTER, Arrays.asList(indexRoute1, indexRoute2, indexLivraison1Route1, indexLivraison2Route1, indexLivraison1Route2, indexLivraison2Route2));
...
//                    for (int indexLivraison2 = indexLivraison1; indexLivraison2 < initialTour.getRoutes().get(indexRoute1).getLivraisons().size(); indexLivraison2++) {
